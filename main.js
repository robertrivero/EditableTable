...
function addProduct() {
  if(productNameElement.value !== "" && productPriceElement.value !== "" && productAmountElement.value !== "" && productDescriptionElement.value !== ""){
    var product = {
    ...
    alert("Please make sure every field is filled");
  }
